...
public class TransactionStatement {
	...
	public void getCustomTransactionStatement() throws SQLException {
        String accountNumber = AtmOperations.inputandvalidateAccountNo();
        String accountPin = AtmOperations.inputandvalidatePin();
        ...
        try {
            ...
            System.out.printf("+---------------+---------------------+---------------+------------+%n");
            System.out.printf("|Transaction ID| Date                | Type          | Amount     |%n");
            System.out.printf("+---------------+---------------------+---------------+------------+%n");
            ...
            while (rs.next()) {
                ...
                System.out.printf("| %-13d| %-20s| %-13s| %-10.2f|%n", transactionId, dateFormat.format(transactionDate), transactionType, amount);
            }
